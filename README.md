...
the first release will probably come out this year, with a 'lite' version on scratch.

WHAT DO YOU MEAN 'lite'?
the 'lite' version will be a scratch version of its TURBOWARP counter-part. only major releases (1.0,2.0,P.OS FIVE, ect.) will have 'lite' releases. (might not use 'lite' title)
